...
class _PageListSurahState extends State<PageListSurah> {
  ...
  void loadData() async {
    String jsonStr = await rootBundle.rootBundle
        .loadString('assets/list_surah/list_surah.json');
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        actions: [
          ...
          IconButton(
            icon: Icon(
              searchMode ? Icons.close : Icons.logout,
              color: Colors.black,
            ),
            onPressed: () async {
            ...
            return GestureDetector(
              onTap: () {
                ...
                Navigator.push(
                    ...
                    MaterialPageRoute(
                        builder: (context) =>
                            PageDetailSurah(strId: strId, strSurah: strSurah)));
              },
              child: Card(
                color: Colors.white,
                      ...
                      child: Column(
                        children: [
                          ListTile(
                            ...
                            subtitle: Text(
                              '${items['arti']} • ${items['ayat'].toString()} ayat',
